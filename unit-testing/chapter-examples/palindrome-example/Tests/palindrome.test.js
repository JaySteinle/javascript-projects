...
describe("isPalindrome", function(){
   ...
   test("shouold return false for a longer non-palindrome", function() {
      expect(isPalindrome("launchcode")).toBe(false);
   })

   test("should return false for a simple palindrome", function() {
   ...
   test("should consider spaces", function() {
